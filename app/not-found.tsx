...
export const metadata: Metadata = {
  title: '404 - Not Found',
  description: '404 - Not Found Profile First',
};
        ...
        <div className="container flex flex-col items-center px-4">
          <div className="max-w-[24rem] text-center">
            ...
            <div>
              <Link
                href="/"
                className="flex justify-center gap-4 py-3 sm:py-4 rounded-lg text-white bg-(--color-primary) transition-opacity duration-150 hover:opacity-80"
              >
                <svg
